                            ...
                            <div class="service-img">
                                <a href="{{ route('servicedetails', $service->slug)}}">
                                    ...
                                    <img class="img-fluid serv-img serviceimg" alt="Service Image"
                                        src="{{ asset('/images/admin/serviceimage/' .$service->serviceimage) }}" style="height:183.62px; width: 274.21px;" />
                                    @else
                                    <img class="img-fluid serv-img serviceimg" alt="Service Image"
                                        src="{{ asset('/images/admin/generalsettings/' .$generalsetting->service_placeholder) }}" style="height:183.62px; width: 274.21px;" />
                                    @endif
                                </a>
                                <div class="item-info">
                                    ...
                                    <div class="cate-list">
                                        <a class="bg-yellow" href="{{ route('servicedetails', $service->slug)}}">{{
                                            $service->category->categoryname }}</a>
                                    </div>
                                </div>
                            </div>
                            <div class="service-content">
                                <h3 class="title">
                                    <a href="{{ route('servicedetails', $service->slug)}}">{{ $service->servicetitle
                                        }}</a>
                                </h3>
                                <div class="user-info">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col text-end">
                                                <a href="javascript:void(0);" class="text-danger" data-toggle="modal"
                                                    data-target="#deleteNotConfirmModal"><i
                                                        class="far fa-trash-alt"></i> Inactive</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
