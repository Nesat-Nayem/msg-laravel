                ...
                <div class="card-body">
                    <div class="row justify-content-start">
                        <div class="col-md-12">
                            ...
                            <form action="{{ route('admin-city.update', $city->id) }}" method="POST" autocomplete="on" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
                                    ...
                                    <div class="row">
                                        <div class="col-md-4 col-12">
                                            <div class="form-group">
                                                <label for="name">Country Name<span class="text-danger">
                                                        *</span></label>
                                                <select name="country_id" id="country_id" class="w-100 form-select required @error('country_id') is-invalid @enderror" onchange="getStates('country_id','state_id');">
                                        ...
                                        <div class="col-md-4 col-12">
                                            <div class="form-group">
                                                <label for="state_id">State Name<span class="text-danger">
                                                        *</span></label>
                                                <select name="state_id" id="state_id" class="w-100 form-select" required>
                                        ...
                                        <div class="col-md-4 col-12">
                                            <div class="form-group">
                                                ...
                                                <input value="{{ $city->cityname }}" type="text" class="form-control @error('cityname') is-invalid @enderror" name="cityname" id="cityname" placeholder="Enter City Name" required autofocus>
                                                @error('cityname')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
