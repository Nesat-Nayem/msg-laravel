    ...
    <div class="page-header">
        <div class="row">
            ...
            <div class="col-auto text-end">
                <a href="{{ route('admin-subcategory.create') }}" class="btn btn-primary add-button ml-3">
                        ...
                        <table class="table table-hover table-center mb-0" id="example">
                            <thead>
                                <tr>
                                    ...
                                    <th style="width: 30%;">Sub Category Slug</th>
                            ...
                            <tbody class="mb-4">
                                ...
                                <tr>
                                    ...
                                    <td class="btn-group">
                                        <a class="edit btn btn-outline-secondary" style="display:inline" href="{{ route('admin-subcategory.edit', $subcategory->id) }}"><i class="fa fa-edit text-success" style="font-size: medium;"></i></a>
