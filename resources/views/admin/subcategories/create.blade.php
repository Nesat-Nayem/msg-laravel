                ...
                <div class="card-body">
                    <div class="row justify-content-start">
                        <div class="col-md-12">
                            ...
                            <form action="{{ route('admin-subcategory.store') }}" method="POST" autocomplete="on" enctype="multipart/form-data">
                                @csrf
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 col-12">
                                            <div class="form-group">
                                                ...
                                                <input value="{{ old('subcategoryname') }}" type="text" class="form-control @error('subcategoryname') is-invalid @enderror" name="subcategoryname" id="subcategoryname" placeholder="Enter Sub Category Name" required onkeyup="generateSlug();">
                                        ...
                                        <div class="col-md-6 col-12">
                                            <div class="form-group">
                                                ...
                                                <input value="{{ old('subcategoryslug') }}" type="text" class="form-control @error('subcategoryslug') is-invalid @enderror" name="subcategoryslug" id="subcategoryslug" placeholder="Enter Sub Category Slug" required readonly>
                                        ...
                                        <div class="col-md-6 col-12">
                                            <div class="form-group">
                                                ...
                                                <select name="status" class="form-select @error('status') is-invalid @enderror" id="status">
                                                    ...
                                                    <option value="inactive" selected {{ old('status') == 'inactive' ? 'selected' : '' }}>
                                                        Inactive</option>
                                                </select>
                                                @error('status')
                                                <span class="invalid-feedback" role="alert">
