                        ...
                        <div class="row justify-content-start">
                            <div class="col-md-12">
                                <div class="section-header d-flex justify-content-between mb-3">
                                    <h2>Add Provider</h2>
                                    <a href="{{ route('admin-provider.index') }}" class="btn btn-primary"
                                        style="height: 34px; border-radius: 30px;"><i
                                            class="fa fa-arrow-left me-2"></i>Back</a>
                                </div>
                                <form action="{{ route('admin-provider.store') }}" method="POST" autocomplete="on"
...
@enderror"
                                            ...
                                            <div class="col-md-6 col-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="radio" name="status" id="active" class="ms-3 me-1"
                                                        value="active" checked><label for="active"
                                                        class="me-2">Active</label>
                                                    <input type="radio" name="status" id="inactive" class="me-1"
                                                        value="inactive"><label for="inactive">Inactive</label>
                                                    @error('status')
                                                        <span class="invalid-feedback" role="alert">
                                                            <strong>{{ $message }}</strong>
                                                        </span>
