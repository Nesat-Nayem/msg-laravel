                ...
                <div class="card-body">
                    <div class="row justify-content-start">
                        <div class="col-md-12">
                            ...
                            <form action="{{ route('admin-country.update', $country->id) }}" method="POST" autocomplete="on" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 col-12">
                                            <div class="form-group">
                                                ...
                                                <input value="{{ $country->countryname }}" type="text" class="form-control @error('countryname') is-invalid @enderror" name="countryname" id="countryname" placeholder="Country Name" required autofocus>
                                            </div>
                                        </div>
                                    </div>
