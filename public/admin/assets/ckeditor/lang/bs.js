...
CKEDITOR.lang["bs"] = {
    ...
    common: {
        ...
        confirmNewPage:
            "Nesačuvane izmjene će biti izgubljene. Da li ste sigurni da želite otvoriti novu stranicu ?",
        confirmCancel:
            "Napravili ste par izmjena. Da li želite zatvoriti prozor ?",
        options: "Opcije",
        target: "Prozor",
        ...
        invalidLength:
            'Vrijednost za "%1" polje mora biti pozitivan broj ili bez ispravne mjerne jedinice (%2).',
        invalidCssLength:
            'Vrijednost za "%1" polje mora biti pozitivan broj ili bez validne CSS mjerne jedinice (px, %, in, cm, mm, em, ex, pt ili pc).',
        invalidHtmlLength:
            'Vrijednost za "%1" polje mora biti pozitivan broj ili bez validne HTML mjerne jedinice (px ili %).',
        invalidInlineStyle:
            'Vrijednost za inline stil mora sadržavati jedan ili više parova u formatu "name: value", razdvojenih tačka-zarezom.',
        cssLengthTooltip:
            "Unesite vrijednost u pikselima ili kao broj sa ispravnom CSS jedinicom (px, %, in, cm, mm, em, ex, pt ili pc).",
    ...
    clipboard: {
        ...
        fileFormatNotSupportedNotification:
            "This file format is not supported. You can try with one of the supported formats: ${formats}.",
    },
    colorbutton: {
        auto: "Automatska",
